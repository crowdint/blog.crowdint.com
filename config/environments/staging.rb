Rails.application.configure do
  ...
  config.action_controller.asset_host = Proc.new do |source, request = nil|
    ...
    #"#{scheme}://cdn#{Digest::MD5.hexdigest(source).to_i(16) % 3}.crowdint.com.global.prod.fastly.net"
    "#{scheme}://#{ENV['AWS_BUCKET']}.s3.amazonaws.com"
   end
  ...
  config.action_mailer.default_url_options = {:host => "blog-staging.crowdint.com"}
